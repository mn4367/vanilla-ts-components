import { getDocument, GlobalWorkerOptions, PDFDocumentLoadingTask } from "pdfjs-dist";
...
export function loadPDF(urlOrOptions: string | DocumentInitParameters): PDFDocumentLoadingTask { // eslint-disable-line jsdoc/require-jsdoc
