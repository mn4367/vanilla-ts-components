import { AElementComponentWithInternalUI, ComponentFactory, getDebouncedFnc, HTMLElementWithChildren, IElementWithChildrenComponent } from "@vanilla-ts/core";
import { Div, P } from "@vanilla-ts/dom";
import { IViewerItemComponent, Viewer, ViewerItemReadyEvent } from "../Viewer.js";
import { Canvas } from "./Canvas.js"; // See there!

////////////////////////////////////////////////////////////////////////////////////////////////////
// `clamp` is only here because in this branch it is not yet part of the dependency
// `@vanilla-ts/core`!
////////////////////////////////////////////////////////////////////////////////////////////////////
/**
 ...
 */
function clamp(n: number, boundary1: number, boundary2: number): number {
