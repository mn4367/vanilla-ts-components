...
export class LabeledRadioButtonFactory<T> extends ComponentFactory<LabeledRadioButton> {
     ...
     */
    public labeledRadioButton(labelText: string, id?: string, value?: string, name?: string, labelAction?: boolean, lblPosition?: LabelPosition, lblAlignment?: LabelAlignment, data?: T) {
