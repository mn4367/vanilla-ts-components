...
import { LabelAlignment, LabelPosition } from "./LabeledComponent";
 ...
 */
export class LabeledCheckbox extends LabeledInputComponent<Checkbox> {
    /**
...
export class LabeledCheckboxFactory<T> extends ComponentFactory<LabeledCheckbox> {
     ...
     */
    public labeledCheckbox(labelText: string, id?: string, value?: string, name?: string, labelAction?: boolean, lblPosition?: LabelPosition, lblAlignment?: LabelAlignment, data?: T) {
